...
(cl:defmethod cl:initialize-instance :after ((m <Adc>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Adc)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name braccio_controller-msg:<Adc> is deprecated: use braccio_controller-msg:Adc instead.")))

(cl:ensure-generic-function 'adc0-val :lambda-list '(m))
(cl:defmethod adc0-val ((m <Adc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader braccio_controller-msg:adc0-val is deprecated.  Use braccio_controller-msg:adc0 instead.")
  (adc0 m))

(cl:ensure-generic-function 'adc1-val :lambda-list '(m))
(cl:defmethod adc1-val ((m <Adc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader braccio_controller-msg:adc1-val is deprecated.  Use braccio_controller-msg:adc1 instead.")
  (adc1 m))

(cl:ensure-generic-function 'adc2-val :lambda-list '(m))
(cl:defmethod adc2-val ((m <Adc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader braccio_controller-msg:adc2-val is deprecated.  Use braccio_controller-msg:adc2 instead.")
  (adc2 m))

(cl:ensure-generic-function 'adc3-val :lambda-list '(m))
(cl:defmethod adc3-val ((m <Adc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader braccio_controller-msg:adc3-val is deprecated.  Use braccio_controller-msg:adc3 instead.")
  (adc3 m))

(cl:ensure-generic-function 'adc4-val :lambda-list '(m))
(cl:defmethod adc4-val ((m <Adc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader braccio_controller-msg:adc4-val is deprecated.  Use braccio_controller-msg:adc4 instead.")
  (adc4 m))

(cl:ensure-generic-function 'adc5-val :lambda-list '(m))
(cl:defmethod adc5-val ((m <Adc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader braccio_controller-msg:adc5-val is deprecated.  Use braccio_controller-msg:adc5 instead.")
  (adc5 m))
