...
%       A_Neck = atan2d(norm(cross(Nose_Vector,Neck_Vector)), dot(Nose_Vector,Neck_Vector));
%       A_RShoulder = atan2d(norm(cross(Neck_Vector,RShoulder_Vector)), dot(Neck_Vector,RShoulder_Vector));
%       A_LShoulder = atan2d(norm(cross(Neck_Vector,LShoulder_Vector)), dot(Neck_Vector,LShoulder_Vector));
%       A_RElbow = atan2d(norm(cross(RShoulder_Vector,RElbow_Vector)), dot(RShoulder_Vector,RElbow_Vector));
%       A_LElbow = atan2d(norm(cross(LShoulder_Vector,LElbow_Vector)), dot(LShoulder_Vector,LElbow_Vector));
% 
%       A_RHip = atan2d(norm(cross(Neck_Vector,RHip_Vector)), dot(Neck_Vector,RHip_Vector));
%       A_LHip = atan2d(norm(cross(Neck_Vector,LHip_Vector)), dot(Neck_Vector,LHip_Vector));
%       
%       A_Rknee = atan2d(norm(cross(RHip_Vector,RKnee_Vector)), dot(RHip_Vector,RKnee_Vector));
%       A_Lknee = atan2d(norm(cross(LHip_Vector,LKnee_Vector)), dot(LHip_Vector,LKnee_Vector));
%     
%       A_RFoot = atan2d(norm(cross(RKnee_Vector,RAnkle_Vector)), dot(RKnee_Vector,RAnkle_Vector));
%       A_LFoot = atan2d(norm(cross(LKnee_Vector,LAnkle_Vector)), dot(LKnee_Vector,LAnkle_Vector));
    ...
    sim.simxSetJointTargetPosition(clientID, Rshoulder_handle, A_Rshoulder(i,1), sim.simx_opmode_oneshot);
    sim.simxSetJointTargetPosition(clientID, Relbow_handle, A_Relbow(i,1), sim.simx_opmode_oneshot);
    
    sim.simxSetJointTargetPosition(clientID, Lshoulder_handle, A_Lshoulder(i,1), sim.simx_opmode_oneshot);
    sim.simxSetJointTargetPosition(clientID, Lelbow_handle, A_Lelbow(i,1), sim.simx_opmode_oneshot);

    sim.simxSetJointTargetPosition(clientID,Rhip_handle, A_Rhip(i,1), sim.simx_opmode_oneshot);
    sim.simxSetJointTargetPosition(clientID, Rknee_handle, A_Rknee(i,1), sim.simx_opmode_oneshot);

    sim.simxSetJointTargetPosition(clientID, Lhip_handle, A_Lhip(i,1), sim.simx_opmode_oneshot);
    sim.simxSetJointTargetPosition(clientID, Lknee_handle, A_Lknee(i,1), sim.simx_opmode_oneshot);
