...
class Snaking(Node):
    ...
    def snaking_control(laser_msg):
        # write your control code here
        # functions to call from external scripts
        print("")

    # call this function whenever you want to publish to ros and pass in the parameters
    # ordered linear x, y, z followed by angular x, y, z
    def publish_twist(lin_x, lin_y, lin_z, ang_x, ang_y, ang_z):
